module itb::ITBToken {
    ...
    public struct ITBTOKEN has drop {}
    ...
    fun init(otw: ITBTOKEN, ctx: &mut TxContext) {
        let (treasury_cap, metadata) = coin::create_currency<ITBTOKEN>(
            otw,
            9, // 9 decimals
            b"ITB", // Symbol
            b"ITBToken", // Name
            b"ITBT Token showcases", // Description
            option::none(), // URL
            ctx
        );
